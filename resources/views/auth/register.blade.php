                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="identifiant" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="identifiant" value="{{ old('identifiant') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Numéro de téléphone : </label>
                            <div class="col-md-6">
